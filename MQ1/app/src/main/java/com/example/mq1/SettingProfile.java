...
public class SettingProfile extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSavenickname = (Button)findViewById(R.id.buttonSavenickname);
        ...
        myRefer.child("Users").child(userw.getUid().toString().trim()).child("Email").setValue(userw.getEmail().toString());
        myRefer.child("Users").child(userw.getUid()).child("imageURL").setValue("default");
        myRefer.addValueEventListener(new ValueEventListener() {
            ...
            if(user.getImageURL().equals("default")){
                ...
                Glide.with(SettingProfile.this).load(user.getImageURL()).into(AvatarView);
            }
            }
